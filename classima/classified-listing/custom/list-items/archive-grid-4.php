        ...
        <div class="rtin-item">
            ...
            <div class="rtin-content">
                ...
                <div class="rtin-bottom">
					<?php if ( $phone ): ?>
                        <div class="rtin-phn">
                            <a class="classima-phone-reveal not-revealed" href="#" data-phone="<?php echo esc_attr( $phone ); ?>"><i class="fa fa-phone"
                                                                                                                                     aria-hidden="true"></i><span><?php esc_html_e( 'Show Phone No',
										'classima' ); ?></span></a>
                        </div>
					<?php endif; ?>
