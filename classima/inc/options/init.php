...
$args = array(
    ...
    'menu_title'           => esc_html__( 'Theme Options', 'classima' ),
    'page_title'           => esc_html__( 'Theme Options', 'classima' ),
...
Helper::requires( 'options/social.php' );
...
Helper::requires( 'options/listing.php' );
Helper::requires( 'options/error.php' );
Helper::requires( 'options/advertisement.php' );

do_action('rt_after_redux_options_loaded','classima');