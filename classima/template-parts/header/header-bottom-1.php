...
<div class="row">
    <div class="col-md-8">
		<?php if ( ! empty( RDTheme::$options['listing_search_items']['keyword'] ) || ! empty( RDTheme::$options['listing_search_items']['location'] ) ): ?>
            <div class="classima-listing-search">
                <form action="<?php echo esc_url( Functions::get_filter_form_url() ); ?>"
                    ...
                    <div class="rtin-btn-holder">
                        <button type="submit" class="rtin-search-btn rdtheme-button-1">
							<?php esc_html_e( 'Search', 'classima' ); ?><i class="fas fa-search" aria-hidden="true"></i>
                        </button>
                    </div>
                </form>
            </div>
    ...
    <div class="col-md-4">
		<?php if ( Helper::is_chat_enabled() ): ?>
            <a class="header-chat-icon rtcl-chat-unread-count" href="<?php echo esc_url( Link::get_my_account_page_link( 'chat' ) ); ?>">
                <i class="far fa-comments" aria-hidden="true"></i><?php esc_html_e( 'Live Chat', 'classima' ); ?>
            </a>
		<?php endif; ?>
		<?php if ( RDTheme::$options['header_icon'] && class_exists( 'RtclPro' ) && class_exists( 'Rtcl' ) ): ?>
            <a class="header-login-icon" data-toggle="tooltip" href="<?php echo esc_url( Link::get_my_account_page_link() ); ?>">
                <i class="far fa-user" aria-hidden="true"></i><?php echo esc_html( $login_icon_title ); ?>
            </a>
		<?php endif; ?>
